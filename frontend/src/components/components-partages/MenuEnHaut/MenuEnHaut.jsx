  ...
  return (
    <nav className="flex items-center justify-between p-(--rythme-base) bg-fond-secondaire">
      <div className="relative">
        ...
        >
          <Icon nom="menuHamburger" typeMenu="haut" couleur="principal-300" />
        </button>
          ...
          <div className="absolute z-50 -left-(--rythme-base) mt-(--rythme-tres-serre) p-(--rythme-base) h-screen min-w-[300px] bg-fond-secondaire shadow-xl rounded-r-(--arrondi-grand) flex flex-col gap-(--rythme-base) transition-transform duration-200">
            <div className="flex justify-between mb-(--rythme-espace)">
              ...
              <button
                ...
                aria-expanded={estMenuOuvert}
              >
                <Icon nom="fermer" typeMenu="haut" couleur="principal-300" />
              </button>
            </div>
      ...
      {estConnecte && (
        <Bouton
          texte={
            <Icon nom="deconnection" typeMenu="haut" couleur="principal-300" />
          }
          type="secondaire"
          typeHtml="button"
