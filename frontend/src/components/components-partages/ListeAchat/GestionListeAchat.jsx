 ...
 * 
 * IMPORTANT: Le store doit être initialisé au niveau parent (Catalogue, Cellier, etc.)
 * via un useEffect qui appelle chargerListeAchat une seule fois.
 */
...
const GestionListeAchat = ({
  ...
  if (chargementInitial || chargementEnCours) {
    return null;
  }
